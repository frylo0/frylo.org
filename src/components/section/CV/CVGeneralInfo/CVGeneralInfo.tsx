...
export const CVGeneralInfo: React.FC<CVGeneralInfoProps> = ({ className = '' }) => {
	return (
		<div className={cn(sCVGeneralInfo, className)}>
			...
			<div className={cn(sCol2)}>
				...
				<div className={cn(sMessage)}>
					<p>
						...
						tapestry of 6 years of experience. My journey has cultivated a vibrant and extensive tech stack, a versatile
					...
					<p>
						...
						Lead and a Frontend CTO. These roles have sculpted me into a strategic thinker, capable of orchestrating and
